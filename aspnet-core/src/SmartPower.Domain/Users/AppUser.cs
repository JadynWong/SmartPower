...
namespace SmartPower.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update SmartPowerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update SmartPowerEfCoreEntityExtensionMappings to extend the IdentityUser entity
